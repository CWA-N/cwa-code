...
function App() {
  // Naya State: Check karega ki user ne Start button dabaya ya nahi
  ...
  // 1. Timer for Hacker Loader (Starts ONLY after button click)
  useEffect(() => {
    if (bootInitiated) {
  ...
  // 2. Typing Effect (Paused during loading)
  useEffect(() => {
    if (loading) return;
    ...
    return () => clearTimeout(timer);
  }, [text, wordIndex, isDeleting, loading]);

  // 3. Scroll Reveal Logic (Runs ONLY after loading is false)
  useEffect(() => {
    if (loading) return; 
  ...
  return (
    <>
      {/* 1. START BUTTON SCREEN */}
      {!bootInitiated && (
        <div className="initiate-screen">
          <button className="btn-initiate" onClick={() => setBootInitiated(true)}>
            [ INITIATE SYSTEM ]
          </button>
        </div>
      )}

      {/* 2. HACKER LOADER (Dikhega jab boot initiate ho aur loading true ho) */}
      {bootInitiated && <Loader isVisible={loading} />}

      {/* 3. MAIN WEBSITE (Dikhegi jab loading false ho jayegi) */}
      {bootInitiated && !loading && (
        <div className="main-content-fade">
          <header className="navbar">
            ...
            <nav>
              <ul className={`nav-links ${menuOpen ? "active" : ""}`}>
                ...
                <li><a href="notes.html" rel="noreferrer">notes</a></li>
              ...
              <div className="hero-grid">
                <div className="reveal">
                  ...
                  <h2>
                    ...
                    <strong className="hero-name">Aasif</strong> — 
                ...
                <div className="hero-visual reveal">
                  ...
                  <div className="image-frame">
                    <img src="/assets/img/hero-developer.png" alt="Python Full Stack Developer" />
                  </div>
          ...
          <section id="about">
            <div className="container">
              ...
              <h2 className="title">My <span>Self.</span></h2>

              <div className="about-grid">
                <div className="about-text reveal">
                  <p>I'm a <strong>BCA Student</strong> and aspiring Python Full Stack Developer passionate about creating scalable and secure digital solutions.</p>
                  <br />
                  <p>I enjoy working with backend architecture, REST APIs, authentication systems, databases, responsive frontend interfaces, and cybersecurity concepts.</p>
                  <br />
          ...
          <section id="skills">
            <div className="container">
              ...
              <div className="skills">
                <SkillCard icon="fa-solid fa-server" title="Backend & APIs" skills={["Python","FastAPI","Django","Flask","REST APIs","JWT"]} />
                <SkillCard icon="fa-solid fa-database" title="Databases" skills={["MySQL","PostgreSQL","SQLite","SQLAlchemy","Django ORM"]} />
                <SkillCard icon="fa-solid fa-code" title="Frontend & Tools" skills={["HTML","CSS","JavaScript","Bootstrap","React","Git","Linux"]} />
              </div>
            </div>
          </section>
          ...
          <section id="projects">
            <div className="container">
              ...
              <div className="projects">
                ...
                <Project title="Your Project Name" description="Add your real project details here." tech={["Python","JavaScript","Database"]} />
          ...
          <section id="contact">
            <div className="container">
              <div className="contact-box reveal">
                ...
                <a href="mailto:cwa02006@gmail.com" className="email">cwa02006@gmail.com</a>
                <br />
                <a href="mailto:cwa02006@gmail.com" className="btn btn-primary">
                  <i className="fa-solid fa-paper-plane"></i> Start a Conversation
                </a>

                <div className="social">
                  <a href="https://github.com/CWA-N" target="_blank" rel="noreferrer"><i className="fa-brands fa-github"></i></a>
                  <a href="https://www.linkedin.com/in/aasif-cwa/" target="_blank" rel="noreferrer"><i className="fa-brands fa-linkedin"></i></a>
                  <a href="https://mail.google.com/mail/?view=cm&fs=1&to=cwa02006@gmail.com" target="_blank" rel="noreferrer"><i className="fa-solid fa-envelope"></i></a>
                </div>
              </div>
            </div>
          </section>

          <footer>© {new Date().getFullYear()} Code With Aasif — Built with code, creativity & consistency.</footer>
        </div>
      )}
    </>
  );
